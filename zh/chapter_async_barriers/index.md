...
<iframe src="../demo_zh/mbarrier_mechanism.html?v=review-20260720" title="mbarrier 的状态与操作" loading="lazy"
        style="width:100%; min-width:1320px; height:730px; border:1px solid var(--pst-color-border, #d0d0d0); border-radius:6px;"></iframe>
</div>
```
...
```{raw} html
<div style="overflow-x:auto;">
<iframe src="../demo_zh/phase_tracking.html?v=phase-order-20260720" title="复用 mbarrier 时的 phase tracking" loading="lazy"
